...
// JSON-LD for FAQ page — FAQPage schema
const faqJsonLd = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "What are the specifications of your Crude Palm Oil (CPO)?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Our CPO has a Free Fatty Acid (FFA) maximum of 5%, Moisture & Impurities maximum of 0.5%, and an Iodine Value (IV) of 50-55.",
      },
    },
    {
      "@type": "Question",
      name: "Do you provide custom packing for RBD Palm Olein?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes, we offer bulk shipments via flexitanks, ISO tanks, and retail packaging like jerry cans or PET bottles based on buyer requirements.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Our MOQ is generally 1x20ft container, which holds approximately 21 metric tons of product depending on the packaging type.",
      },
    },
    {
      "@type": "Question",
      name: "What are your standard payment terms?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "We typically accept T/T (Telegraphic Transfer) and Irrevocable L/C (Letter of Credit) at sight.",
      },
    },
    {
      "@type": "Question",
      name: "Are your products RSPO certified?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes, we source our palm oil from RSPO-certified mills and plantations, ensuring sustainable and ethical practices.",
      },
    },
    {
      "@type": "Question",
      name: "How can we become an exclusive distributor?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Please fill out our detailed inquiry form on the Contact page, and our business development team will schedule a meeting to discuss exclusive partnership models.",
      },
    },
  ],
};
